<template>
    <div class="template3">
        <!-- 封面卡片 -->
        <div v-if="type === 'cover'"
            class="xhs-card cover-card flex flex-col justify-end items-start p-8 text-left bg-gradient-to-br from-yellow-400 to-orange-500 w-80 aspect-[3/4]">
        ...
        <div v-else-if="type === 'content'" class="xhs-card content-card flex flex-col p-6 bg-white w-80 aspect-[3/4]">
            ...
            <div class="markdown-content flex-grow text-gray-700 katex-compatible overflow-y-auto"
